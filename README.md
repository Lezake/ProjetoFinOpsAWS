...
<p align="center">
  <img src="docs/architecture.png" alt="Diagrama de Arquitetura FinOps AWS" width="500">
</p>
...
* **Isolamento por Tags:** A rotina em Python (Boto3) atua exclusivamente nos recursos mapeados com a tag `environment=dev`.
